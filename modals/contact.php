<?php if(!isset($conn)) die('<title>Access Denied</title><i>This page cannot be accessed directly'); ?>
	   ...
	   <form id="contact_form" role="form" onsubmit="return false;">
     ...
     <!-- Name input-->
		...
		<div class="form-group">
         <img id="captcha_3" src="ajax/action.php?captcha&background=<?php echo MainColor ?>" onclick="this.src='ajax/action.php?captcha&background=<?php echo MainColor ?>&' + Math.random();" alt="captcha" style="cursor:pointer;">
