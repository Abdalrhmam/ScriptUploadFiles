 ...
 <table class="table" id="tablefiles">
    <thead>
      <tr>
        ...
        <th><i class="glyphicon glyphicon-file"></i> <?php echo $lang[36]?></th>
		<th class="hidden-xs"><i class="glyphicon glyphicon-scale"></i> <?php echo $lang[42]?></th>
        ...
        <th class="hidden-xs"><i class="glyphicon glyphicon-time"></i> <?php echo $lang[33]?></th>
		<th><i class="glyphicon glyphicon-cog"></i> <?php echo $lang[43]?></th>
      </tr>
    </thead>
    <tbody id="tbody">
    </tbody>
