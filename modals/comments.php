...
{
?>
<div id="comments" class="main top20 animated bounceInDown">

           <div class="row"> 	
		      <div class="ribbon orange"><span><?php echo $lang[240] ?> </span></div>	
              <div class="top70 col-xs-12"> 
					    ...
					    <div class="row">
                            ...
                            <div class="col-sm-12 col-md-11">
					            <form id="add_comment_form" role="form" onsubmit="return false;">
					                <input  id="comment_file_id" value="<?php echo $_GET['download'] ?>" name="file_id" type="hidden" >
									...
									<div class="form-group">
									 ...
									 <div class="form-group">
									    <img id="captcha_6" src="ajax/action.php?captcha&background=<?php echo MainColor ?>" onclick="this.src='ajax/action.php?captcha&background=<?php echo MainColor ?>&' + Math.random();" alt="captcha" style="cursor:pointer;">
