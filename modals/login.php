...
<form id="login_form" role="form" onsubmit="return false;">
  ...
  <?php if(EnableCaptcha){?>
    <div class="form-group">
    <img id="captcha_1" src="ajax/action.php?captcha&background=<?php echo MainColor ?>" onclick="this.src='ajax/action.php?captcha&background=<?php echo MainColor ?>&' + Math.random();" alt="captcha" style="cursor:pointer;">
